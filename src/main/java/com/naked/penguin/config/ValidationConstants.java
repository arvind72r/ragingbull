...
public class ValidationConstants {
    ...
    public static final int ORG_NAME_MIN = 1;
    public static final int ORG_NAME_MAX = 128;
    public static final String ORG_NAME_MSG_SIZE = "Name must be between "+ORG_NAME_MIN+" and "+ORG_NAME_MIN+" characters";
    public static final String ORG_NAME_MSG_EMPTY = "The name cannot be empty";

    public static final int GROUP_NAME_MIN = 1;
    public static final int GROUP_NAME_MAX = 128;
    public static final String GROUP_NAME_MSG_SIZE = "Name must be between "+GROUP_NAME_MIN+" and "+GROUP_NAME_MAX+" characters";
    public static final String GROUP_NAME_MSG_EMPTY = "The name cannot be empty";
