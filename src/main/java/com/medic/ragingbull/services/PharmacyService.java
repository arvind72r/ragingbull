...
public class PharmacyService {
    ...
    public PharmacyResponse createPharmacy(User user, Pharmacy pharmacy, Boolean includeDetails) throws ResourceCreationException {
        ...
        try {
            ...
            Integer deliveryRadius = pharmacy.getDeliveryRadius() == null ? SystemContants.DEFAULT_DELIVERY_RADIUS : pharmacy.getDeliveryRadius();
            Integer workingHours = pharmacy.getWorkingHours() == null ? SystemContants.DEFAULT_WORKING_HOURS : pharmacy.getWorkingHours();
            Integer workingDays = pharmacy.getWorkingDays() == null ? SystemContants.DEFAULT_WORKING_DAYS : pharmacy.getWorkingDays();
