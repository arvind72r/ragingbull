...
public class UserRoles{
    ...
    public enum Role {
        ...
        NATIVE_USER(Permissions.USER_READ, Permissions.USER_MODIFY, Permissions.USER_DELETE, Permissions.USER_MEMBER_ADD, Permissions.USER_MEMBER_READ,Permissions.USER_MEMBER_DELETE, Permissions.USER_MEMBER_MODIFY),
