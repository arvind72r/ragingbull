...
public class UserRoles{
    ...
    public enum Role {
        ...
        NATIVE_USER(Permissions.USER_READ, Permissions.USER_MODIFY, Permissions.USER_DELETE, Permissions.USER_MEMBER_ADD, Permissions.USER_MEMBER_READ,Permissions.USER_MEMBER_DELETE, Permissions.USER_MEMBER_MODIFY, Permissions.PRACTITIONER_LOCATION_CONSULTATION_ADD, Permissions.PRACTITIONER_LOCATION_CONSULTATION_READ),
        NATIVE_MEMBER(Permissions.USER_READ, Permissions.USER_MODIFY, Permissions.USER_DELETE),
        NATIVE_PRACTITIONER(NATIVE_USER, Permissions.PRACTITIONER_LOCATION_ADD , Permissions.PRACTITIONER_LOCATION_MODIFY , Permissions.PRACTITIONER_LOCATION_DELETE),
