...
public class UserRoles{
    ...
    public enum Permissions {
        ...
        USER_CONSULTATION_READ(512),
        USER_CONSULTATION_MODIFY(1024),
        USER_CONSULTATION_DELETE(2048),

        USER_ORDER_CREATE(4096),
        USER_ORDER_CANCEL(8192),

        // Practitioner Privileges
        PRACTITIONER_READ(131072),
        PRACTITIONER_MODIFY(262144),
        PRACTITIONER_DELETE(524288),
        PRACTITIONER_READ_OTHER(1048576),

        PRACTITIONER_LOCATION_ADD(2097152),
        PRACTITIONER_LOCATION_MODIFY(4194304),
        PRACTITIONER_LOCATION_DELETE(8388608),

        PRACTITIONER_LOCATION_USER_ADD(16777216),
        PRACTITIONER_LOCATION_USER_REMOVE(33554432),

        PRACTITIONER_LOCATION_CONSULTATION_ADD(67108864),
        PRACTITIONER_LOCATION_CONSULTATION_MODIFY(134217728),
        PRACTITIONER_LOCATION_CONSULTATION_DELETE(268435456),

        PRACTITIONER_LOCATION_CONSULTATION_PRESCRIPTION_ADD(536870912),
